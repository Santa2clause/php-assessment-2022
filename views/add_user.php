                        ...
                        <div class="col-xl">
                            <div class="card mb-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="add-user" class="was-validated">
                                        <input type="text" name="formType" id="formType" value="addUser" hidden/>

                                        <?php include 'form-details.php'; ?>

                                        <input type="button" class="addButton btn btn-success" value="Add New User" />
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(function(){
        ...
        //Verify User Exist
        let userEmailInput = $('#user-email');
        let userDivWarning = $('.user-input-email-id');
        userEmailInput.keyup(function(){
            $.post(
                ...
                {
                    formType: 'readUser',
                    pEmail: userEmailInput.val()
                },
                function(data){
                    if($.trim(data) === 'Exists'){
                        userEmailInput.val('');
                        userDivWarning.text("User Already Exist").css('color','red');
                    }
                }
